...
export interface Pet { img: string; name: string; desc: string; isNew?: boolean; }
...
export const COPY: Record<Lang, Copy> = {
  ko: {
    ...
    intro: {
      ...
      pets: [
        ...
        { img: 'assets/cat.png', name: '고양이', desc: '장난감을 좋아하는 친절한 고양이. 하지만 언제 펀치를 날릴지 모른다.' },
        { img: 'assets/lizard.png', name: '도마뱀', desc: '무슨 생각을 하는지 알 수 없는 도마뱀. 유일하게 벽을 타고 다닌다.' },
        { img: 'assets/otter.png', name: '해달', desc: '온순하고 귀여운 해달. 세상에서 조개껍데기를 가장 좋아한다.' },
      ],
    },
    gallery: {
      title: '화면 위에서 함께',
  ...
  en: {
    ...
    intro: {
      ...
      pets: [
        { img: 'assets/axolotl.png', name: 'Axolotl', desc: 'A rosy little axolotl from the water — always just a little bit damp.', isNew: true },
  ...
  ja: {
    ...
    intro: {
      ...
      pets: [
        { img: 'assets/axolotl.png', name: 'ウーパールーパー', desc: '水からやってきたピンクのウーパールーパー。いつもちょっと湿っています。', isNew: true },
